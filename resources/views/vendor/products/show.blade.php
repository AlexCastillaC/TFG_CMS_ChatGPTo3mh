...
<div class="container">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-footer">
            <a href="{{ route('vendor.products.index') }}" class="btn btn-secondary">Volver a la lista</a>
            <a href="{{ route('vendor.products.edit', $product->id) }}" class="btn btn-primary">Editar Producto</a>
        </div>
    </div>
</div>
@endsection
