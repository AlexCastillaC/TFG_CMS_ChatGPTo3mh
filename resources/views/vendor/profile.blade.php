...
@section('content')
    ...
    <!-- Enlaces para la gestión de productos -->
    <div class="mb-4">
        <a href="{{ route('vendor.products.index') }}" class="btn btn-info">Ver mis productos</a>
        <a href="{{ route('vendor.products.create') }}" class="btn btn-success">Crear nuevo producto</a>
    </div>
